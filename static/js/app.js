...
function checkDuplicate(tagName, tagText) {
    console.log(d3.select(tagName+"1").text())
    console.log(d3.select(tagName+"2").text())
    console.log(d3.select(tagName+"3").text())
    console.log(tagText)
    return ((d3.select(tagName+"1").text() == tagText) ||
            (d3.select(tagName+"2").text() == tagText) || 
            (d3.select(tagName+"3").text() == tagText)) ? true:false;
};
